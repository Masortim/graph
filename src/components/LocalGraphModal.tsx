        ...
        <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden text-xs">
          <div className="px-6 py-4 border-b border-slate-800 bg-slate-950/80 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-sm text-slate-100">Show Full Graph?</h3>
            </div>
          ...
          <div className="p-6 space-y-3 text-slate-300">
            <p className="text-xs leading-relaxed">
              You are currently viewing the local subgraph for <strong className="text-sky-300">«{node.labelEn}»</strong>.
            </p>
            <p className="text-slate-400 text-[11px]">
              Return to displaying all nodes and relationships across the full graph?
            </p>
          </div>
    ...
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden text-xs">
        <div className="px-6 py-4 border-b border-slate-800 bg-slate-950/80 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Network className="w-4 h-4 text-sky-400" />
            <h3 className="font-bold text-sm text-slate-100">Local Subgraph Explorer</h3>
          </div>
          <button onClick={onClose} className="text-slate-400 hover:text-slate-200">
            <X className="w-4 h-4" />
          </button>
        ...
        <div className="p-6 space-y-4">
          <div>
            <div className="text-[11px] text-slate-400 mb-1">Target concept node:</div>
          ...
          <div>
            <label className="font-semibold text-slate-300 block mb-2 flex items-center gap-1.5 text-xs">
              <Layers className="w-3.5 h-3.5 text-sky-400" /> Connection Depth:
            </label>
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <span className="font-bold text-xs">Depth 1</span>
                  {depth === 1 && <Check className="w-3.5 h-3.5 text-sky-400" />}
                </div>
                <div className="text-[10px] text-slate-400 leading-tight">
                  Direct neighbors of the node and connections between them
                </div>
              </button>
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <span className="font-bold text-xs">Depth 2</span>
                  {depth === 2 && <Check className="w-3.5 h-3.5 text-sky-400" />}
                </div>
                <div className="text-[10px] text-slate-400 leading-tight">
                  1st and 2nd degree neighbors and mutual dependencies
                </div>
              </button>
            </div>
          </div>
        ...
        <div className="px-6 py-3 border-t border-slate-800 bg-slate-950/80 flex justify-end gap-2">
          ...
          >
            <Network className="w-3.5 h-3.5" /> Show Subgraph
          </button>
        </div>
      </div>
    </div>
